...
namespace Mineclone {
    ...
    void InputActionSystem::setDefaultBindings() {
        ...
        bindAction(InputAction::CROUCH, GLFW_KEY_LEFT_SHIFT);
        ...
        bindAction(InputAction::DEBUG_TOGGLE_CURSOR, GLFW_KEY_F2);
        bindAction(InputAction::DEBUG_TOGGLE_WIREFRAME, GLFW_KEY_F1);
        bindAction(InputAction::DEBUG_TOGGLE_GAMEMODE, GLFW_KEY_F4);
