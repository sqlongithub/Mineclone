...
#include "client/input/systems/CursorSystem.h"
#include "client/input/systems/InputActionSystem.h"

namespace Mineclone {

    Application::Application(const std::string &title)
        : m_window("Mineclone", 2160, 1215),
          m_game(m_registry, m_systemManager, m_window) {
